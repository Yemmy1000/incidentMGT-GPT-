...
class ChainOfThought:
    ...
    def start_conversation(self):
        self.stage = 0
        greet = '\t welcome to CybersecOpsGPT: An AI-based asisistive tool for cybersecurity security experts\n \t I will assist you using a model based on the outline:'
    ...
    def process_input(self, user_input, response):
        if self.stage == 0:
            ...
            return self.final_thoughts(user_input)
    ...
    def final_thoughts(self, user_input, response):
        history = responseStorage.get_all_mappings() 
